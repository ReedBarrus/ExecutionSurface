# ExecutionSurface Historical Archive
...
Archived files may still be useful for:

- historical trace
- prior sequencing rationale
- prior workflow law
- prior cycle history

Archived files must not be used by themselves to settle:

- current runtime object law
- current commit-boundary law
- current substrate topology
